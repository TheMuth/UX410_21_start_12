sap.ui.define([
	...
	function (Controller, Filter, FilterOperator, Sorter) {
		...
		return Controller.extend("studentXX.sap.training.ex_12dynamicpage.controller.Overview", {
            onInit: function() {
            ...
            onOpenViewSettings: function(oEvent) {
			    if (!this._oViewSettingsDialog) {
				    this._oViewSettingsDialog = sap.ui.xmlfragment(
                        "studentXX.sap.training.ex_12dynamicpage.fragments.ViewSettingsDialog", 
                        this
                    );
